      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in-left">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-white/20 backdrop-blur-sm rounded-full mb-6 shadow-2xl animate-bounce-in">
              <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
              </svg>
            </div>
            
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 drop-shadow-2xl leading-tight animate-fade-in-up stagger-1">
              {locale === 'en' ? 'Ready to Transform Your Farming?' : 'اپنی کاشتکاری کو تبدیل کرنے کے لیے تیار ہیں؟'}
            </h2>
            <p className="text-xl text-white/90 mb-8 leading-relaxed drop-shadow-lg animate-slide-up stagger-2">
              {t('home.cta.subtitle')}
            </p>
            
            {/* Contact Info */}
            <div className="space-y-4 mb-8 animate-fade-in-up stagger-3">
              <div className="flex items-center text-white/90 group hover:text-white transition-colors duration-300">
                <div className="flex items-center justify-center w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full mr-3 group-hover:scale-110 transition-transform duration-300">
                  <Phone className="w-5 h-5" />
                </div>
                <span className="text-lg font-semibold">+92 300 1234567</span>
              </div>
              <div className="flex items-center text-white/90 group hover:text-white transition-colors duration-300">
                <div className="flex items-center justify-center w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full mr-3 group-hover:scale-110 transition-transform duration-300">
                  <Mail className="w-5 h-5" />
                </div>
                <span className="text-lg font-semibold">info@oceanica.com</span>
              </div>
              <div className="flex items-center text-white/90 group hover:text-white transition-colors duration-300">
                <div className="flex items-center justify-center w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full mr-3 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-bounce-in">
              <Link 
                href="/contact-us" 
                className="bg-gradient-to-r from-white to-gray-100 text-blue-600 hover:from-gray-100 hover:to-white px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-3xl inline-flex items-center justify-center shadow-2xl"
              >
              ...
              <Link 
                ...
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-3xl inline-flex items-center justify-center backdrop-blur-sm"
              >
          ...
          <div className="animate-fade-in-right">
            <div className="bg-white/15 backdrop-blur-md rounded-3xl p-8 border border-white/30 shadow-2xl">
              <div className="text-center mb-6">
                ...
                <div className="w-16 h-1 bg-gradient-to-r from-white to-transparent mx-auto rounded-full"></div>
              </div>
