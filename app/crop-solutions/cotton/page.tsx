  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-32 overflow-hidden m-2" style={{borderRadius:"20px"}}>
        {/* Background Image */}
        <Image
          src="/assets/crops/cotton/hero-banner.jpg"
          alt="Cotton Field Background"
          fill
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              <h1 className="text-6xl font-bold mb-6 leading-tight">
                Cotton Gold Better Program
              </h1>
              <p className="text-3xl font-bold text-blue-300 mb-8">
                Practical Solution for Fiber Quality!
              </p>
              <p className="text-xl text-white/90 mb-8">
                Comprehensive cotton solutions for sustainable farming and premium fiber production
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
              <div className="text-center">
                ...
                <Link href="/products/search/crop-protection" className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold transition-colors duration-200 inline-flex items-center">
                  Oceanica Products
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/assets/crops/cotton/fresh-cotton-bolls.jpg"
                  alt="Fresh Cotton Bolls"
                  fill
                  className="object-cover"
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative h-40 rounded-xl overflow-hidden shadow-lg">
                  <Image
                    src="/assets/crops/cotton/cotton-plant.jpg"
                    alt="Cotton Plant"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="relative h-40 rounded-xl overflow-hidden shadow-lg">
                  <Image
                    src="/assets/crops/cotton/cotton-field.jpg"
                    alt="Cotton Field"
                    fill
                    className="object-cover"
                  />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gray-900 mb-6">Cotton Crop Program</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Oceanica Crop Program for Cotton Productivity
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <div className="relative max-w-6xl">
              ...
              <div className="absolute bottom-4 right-4">
                <div className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-lg shadow-lg border border-blue-200">
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-white rounded-3xl p-12 text-center shadow-2xl">
            <div className="w-24 h-24 bg-gradient-to-br from-blue-400 to-indigo-500 rounded-full flex items-center justify-center mx-auto mb-8">
              <Leaf className="w-12 h-12 text-white" />
            </div>
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Boost Your Cotton Quality with Oceanica
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Discover our comprehensive range of cotton protection products designed specifically for Pakistani growing conditions
            </p>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">
                    Oceanica Pakistan - Cotton Solutions
                  </h4>
                  <p className="text-gray-600">Learn about our comprehensive cotton protection solutions</p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Cotton Crop Program</p>
                      <p className="text-sm text-gray-600">(2.8 MB)</p>
                    </div>
                    <Download className="w-5 h-5 text-gray-600" />
                  </div>
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    <Download className="w-5 h-5 text-gray-600" />
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Cotton Growing Guide</p>
                      <p className="text-sm text-gray-600">(2.1 MB)</p>
                    </div>
                    <Download className="w-5 h-5 text-gray-600" />
                  </div>
                </div>
      ...
      <section className="py-20 bg-primary-600">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Ready to Transform Your Cotton Production?
          </h2>
          <p className="text-xl text-primary-100 mb-8 max-w-3xl mx-auto">
            Contact our cotton specialists today for personalized recommendations 
            and expert guidance on maximizing your cotton production.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
