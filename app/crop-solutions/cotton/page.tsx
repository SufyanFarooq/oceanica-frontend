  ...
  const solutions = [
    {
      ...
      description: 'Advanced seed protection for cotton with improved germination and disease control',
      icon: '🌱',
      benefits: ['Early disease protection', 'Better germination', 'Stronger seedlings']
    },
    {
      title: 'Herbicide Solutions',
      description: 'Selective weed control products designed specifically for cotton fields',
      icon: '🌿',
      benefits: ['Broad-spectrum weed control', 'Crop safety', 'Residual activity']
    },
    {
      title: 'Insecticide Protection',
      description: 'Targeted control for cotton pests like bollworms and aphids',
      icon: '🦗',
      benefits: ['Pest-specific targeting', 'Long-lasting protection', 'Minimal resistance risk']
    },
    {
      title: 'Fungicide Management',
      description: 'Disease prevention for cotton diseases like bacterial blight and wilt',
      icon: '🍄',
      benefits: ['Blight protection', 'Wilt control', 'Yield preservation']
    }
  ]
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Comprehensive solutions for high-quality cotton production in Pakistan. 
              From seed to harvest, protect your cotton crop and maximize fiber quality.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Complete Cotton Protection
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our integrated approach addresses every stage of cotton development 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Common Cotton Challenges
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We understand the unique challenges Pakistani cotton farmers face 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Why Choose Oceanica for Cotton?
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Fiber Quality Focus</h3>
              <p className="text-gray-600">Solutions that improve both yield and fiber quality</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Expert advice throughout the cotton growing season</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Understanding of Pakistan's cotton growing regions</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-primary-600">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Ready to Boost Your Cotton Quality?
          </h2>
