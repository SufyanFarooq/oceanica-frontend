            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 lg:p-12 bg-gradient-to-br from-green-600 to-green-700 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="mb-6">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-4">Boost Your Sugarcane Yields</h2>
                    <p className="text-lg opacity-90">Discover our comprehensive range of sugarcane protection products designed specifically for Pakistani growing conditions</p>
                  </div>
