      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gray-900 mb-6">Wheat Crop Program</h2>
          ...
          <div className="flex justify-center">
            <div className="relative max-w-6xl">
              <Image
                ...
                width={1200}
                height={800}
                className="rounded-2xl shadow-2xl border-2 border-amber-200"
                priority
              />
              <div className="absolute bottom-4 right-4">
                <div className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-lg shadow-lg border border-amber-200">
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-primary-700">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-white rounded-3xl p-12 text-center shadow-2xl">
            <div className="w-24 h-24 bg-gradient-to-br from-amber-400 to-yellow-500 rounded-full flex items-center justify-center mx-auto mb-8">
              <Leaf className="w-12 h-12 text-white" />
            </div>
            ...
            <div>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600">Learn about our comprehensive wheat protection solutions</p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Wheat Crop Program</p>
                      <p className="text-sm text-gray-600">(3.1 MB)</p>
                    </div>
                    <Download className="w-5 h-5 text-gray-600" />
                  </div>
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    <Download className="w-5 h-5 text-gray-600" />
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Wheat Growing Guide</p>
