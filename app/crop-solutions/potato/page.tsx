  ...
  const solutions = [
    {
      ...
      description: 'Advanced seed protection for potatoes with improved germination and disease control',
      icon: '🌱',
      benefits: ['Early disease protection', 'Better germination', 'Stronger seedlings']
    },
    {
      title: 'Herbicide Solutions',
      description: 'Selective weed control products designed specifically for potato fields',
      icon: '🌿',
      benefits: ['Broad-spectrum weed control', 'Crop safety', 'Residual activity']
    },
    {
      title: 'Insecticide Protection',
      description: 'Targeted control for potato pests like Colorado potato beetle and aphids',
      icon: '🦗',
      benefits: ['Pest-specific targeting', 'Long-lasting protection', 'Minimal resistance risk']
    },
    {
      title: 'Fungicide Management',
      description: 'Disease prevention for potato diseases like late blight and early blight',
      icon: '🍄',
      benefits: ['Late blight protection', 'Early blight control', 'Yield preservation']
    }
  ]
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Comprehensive solutions for high-yield potato production in Pakistan. 
              From seed to harvest, protect your potato crop and maximize quality.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Complete Potato Protection
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our integrated approach addresses every stage of potato development 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We understand the unique challenges Pakistani potato farmers face 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Why Choose Oceanica for Potatoes?
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Solutions that improve both yield and tuber quality</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Expert advice throughout the potato growing season</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Understanding of Pakistan's potato growing regions</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-primary-600">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Ready to Boost Your Potato Production?
          </h2>
