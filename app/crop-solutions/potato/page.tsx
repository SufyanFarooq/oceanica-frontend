        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-white rounded-3xl p-12 text-center shadow-2xl">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Boost Your Potato Quality with Oceanica
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Discover our comprehensive range of potato protection products designed specifically for Pakistani growing conditions
            </p>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">
                    Oceanica Pakistan - Potato Solutions
                  </h4>
                  <p className="text-gray-600">Learn about our comprehensive potato protection solutions</p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Potato Crop Program</p>
                      <p className="text-sm text-gray-600">(2.9 MB)</p>
                    </div>
                    <Download className="w-5 h-5 text-gray-600" />
                  </div>
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    <Download className="w-5 h-5 text-gray-600" />
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Potato Growing Guide</p>
