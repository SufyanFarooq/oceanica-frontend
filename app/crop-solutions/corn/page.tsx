          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              <h1 className="text-6xl font-bold mb-6 leading-tight">
                Corn Gold Better Program
              </h1>
              <p className="text-3xl font-bold text-blue-300 mb-8">
                Practical Solution for Yield!
              </p>
              <p className="text-xl text-white/90 mb-8">
                Comprehensive corn solutions for sustainable farming and food security
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20">
              <div className="text-center">
                ...
                <Link href="/products/search/crop-protection" className="bg-yellow-500 hover:bg-yellow-600 text-black px-8 py-3 rounded-lg font-semibold transition-colors duration-200 inline-flex items-center">
                  Oceanica Products
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/assets/landing/crops/corn.jpg"
                  alt="Fresh Corn Cobs"
                  fill
                  className="object-cover"
                />
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gray-900 mb-6">Corn Crop Program</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Syngenta Crop Program for Corn Productivity
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <div className="relative max-w-6xl">
              <Image
                ...
                alt="Corn Crop Program Guide"
                width={1200}
                height={800}
                className="rounded-2xl shadow-2xl border-2 border-yellow-200"
                priority
              />
              <div className="absolute bottom-4 right-4">
                <div className="inline-flex items-center space-x-2 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-lg shadow-lg border border-yellow-200">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-white rounded-3xl p-12 text-center shadow-2xl">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              Boost Your Corn Yields with Oceanica
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Discover our comprehensive range of corn protection products designed specifically for Pakistani growing conditions
            </p>
              ...
              <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <h4 className="text-lg font-semibold text-gray-900 mb-2">
                    Oceanica Pakistan - Corn Solutions
                  </h4>
                  <p className="text-gray-600">Learn about our comprehensive corn protection solutions</p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    ...
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Corn Crop Program</p>
                  ...
                  <div className="flex items-center space-x-3 p-4 bg-white rounded-lg shadow-sm">
                    <Download className="w-5 h-5 text-gray-600" />
                    <div className="flex-1">
                      <p className="font-medium text-gray-900">Corn Growing Guide</p>
                      <p className="text-sm text-gray-600">(1.8 MB)</p>
                    </div>
                    <Download className="w-5 h-5 text-gray-600" />
                  </div>
                </div>
      ...
      <section className="py-20 bg-primary-600">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold text-white mb-4">
            Ready to Transform Your Corn Production?
          </h2>
