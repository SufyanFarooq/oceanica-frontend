          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="relative h-80 rounded-2xl overflow-hidden shadow-xl">
                <Image
                  src="/assets/crops/corn/fresh-corn-cobs.jpg"
                  alt="Fresh Corn Cobs"
                  fill
                  className="object-cover"
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="relative h-40 rounded-xl overflow-hidden shadow-lg">
                  <Image
                    src="/assets/crops/corn/dried-corn-cob.jpg"
                    alt="Dried Corn Cob"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="relative h-40 rounded-xl overflow-hidden shadow-lg">
                  <Image
                    src="/assets/crops/corn/corn-plant.jpg"
                    alt="Corn Plant"
                    fill
                    className="object-cover"
                  />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              ...
              <div className="p-8 lg:p-12 bg-gradient-to-br from-green-600 to-green-700 text-white relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="mb-6">
                    <h2 className="text-3xl lg:text-4xl font-bold mb-4">Boost Your Corn Yields</h2>
                    <p className="text-lg opacity-90">Discover our comprehensive range of corn protection products designed specifically for Pakistani growing conditions</p>
                  </div>
