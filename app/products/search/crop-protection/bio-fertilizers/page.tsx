...
import { ArrowRight, Leaf, Zap, Droplets, Flame, Sprout, Microscope, Filter, Grid, List, Star, ShoppingCart, Heart, Search, SlidersHorizontal } from 'lucide-react'
...
export default function BioFertilizers() {
  ...
  const allProducts = productCategories.flatMap(category => 
    category.products.map((product, index) => ({
      ...
      price: 1200 + (index * 150), // Fixed price based on index (lower range for bio)
      rating: 4.7, // Fixed rating
      reviews: 20 + (index * 3), // Fixed reviews based on index
  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-accent-900 via-accent-800 to-accent-900 text-white py-32 overflow-hidden m-2" style={{borderRadius:"20px"}}>
        {/* Background Image */}
        <Image
          src="/assets/products/Bio Fertilizers/hero-banner.jpg"
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              {locale === 'en' ? 'Shop Bio Fertilizers' : 'بائیو کھادیں خریدیں'}
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {locale === 'en'
                ? 'Browse our comprehensive range of natural and organic bio-fertilizers for sustainable agriculture'
                : 'پائیدار زراعت کے لیے ہماری قدرتی اور نامیاتی بائیو کھادوں کی جامع رینج دیکھیں'
              }
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder={locale === 'en' ? 'Search bio products...' : 'بائیو پروڈکٹس تلاش کریں...'}
                  value={searchQuery}
